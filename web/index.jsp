                ...
                <section id="tm-section-1" class="tm-section">
                    <div class="ml-auto">
                        ...
                        <p class="mb-5 tm-font-big">
                            To see the products you need to log in. Click continue to register.</p>
                        <a href="loginPassword.jsp" class="btn tm-btn tm-font-big"
                           data-nav-link="#tmNavLink2">Continue...</a>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-12 col-xl-6 mb-4">
                            <div class="media tm-bg-transparent-black tm-border-white">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>We provide a variety of templates for you at no cost. Please spread a word about
                                        <a
                                                href="https://plus.google.com/+tooplate" target="_parent">Tooplate</a>
                                        website.
                                        Thank you.</p>
                                </div>
                            </div>
